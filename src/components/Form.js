    ...
    return (
        <form ref={form} onSubmit={sendEmail}>
            <div className='text-3xl p-4 m-2 flex flex-col items-center md:items-start gap-1'>
                ...
                <input value={name} onChange={(e)=> setName(e.target.value)} name='userName' className='py-1 md:ps-2 md:py-2 rounded-lg bg-slate-100' type='text' id='name' required />
            </div>
            ...
            <div className='text-3xl p-4 m-2 flex flex-col items-center md:items-start gap-2'>
                ...
                <input value={email} onChange={(e)=> setEmail(e.target.value)} type="email" name="userEmail" className='py-1 md:ps-2 md:py-2 rounded-lg bg-slate-100'  id='email' required />
            </div>
            ...
            <div className='text-3xl p-4 m-2 flex flex-col items-center md:items-start gap-2'>
                ...
                <textarea value={message} onChange={(e)=> setMessage(e.target.value)}  rows="5" cols="20" className=' pt-2  md:px-1 mx-5 md:mx-0 rounded-lg bg-slate-100'  id="message" name='message' placeholder='Enter text here...' required></textarea>
            </div>
