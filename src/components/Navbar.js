...
export default function Navbar() {
  return (
    <>
      <div className='flex md:justify-center justify-between md:px-0 px-6 items-center gap-10 w-full h-20 md:my-3'>
        <div className='cursor-pointer'><img src={Logo} alt='LOGO' className='w-28 h-20 me-[-50px] z-50' /></div>
        <div className=''>
