  ...
  return (
    <>
      <div className='flex md:justify-center justify-between md:px-0 px-6 items-center gap-7 w-full h-20 md:my-3'>
        ...
        <div className=''>
          <a href="#" className="hover:bg-[#04200E]"><h2 className='bg-blue-400 text-[#FFFFFF] hover:bg-white hover:text-blue-400 hover:outline hover:rounded-sm md:p-4 md:px-8 px-4 py-3 rounded-md text-sm font-bold  transition-all duration-300 whitespace-nowrap'>Get Started</h2></a>
        </div>
